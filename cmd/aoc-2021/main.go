...
import (
	...
	"github.com/BrennanMacKay/aoc-2021/internal/d16"
	"github.com/BrennanMacKay/aoc-2021/internal/d17"
	"github.com/BrennanMacKay/aoc-2021/internal/d2"
	"github.com/BrennanMacKay/aoc-2021/internal/d22"
...
func main() {
	...
	case "d16":
		os.Exit(d16.Day16(os.Args[2:]))
	case "d17":
		os.Exit(d17.Day17(os.Args[2:]))
	case "d22":
		os.Exit(d22.Day22(os.Args[2:]))
	default:
